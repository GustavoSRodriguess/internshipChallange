const prod = new (function(){
    ...
    this.amount = document.getElementById('amountProd');
    this.price = document.getElementById('priceProd');
    this.category_code = document.getElementById('category_code');
    ...
    this.populateCategories = () => {
        ...
        .then((data) => {
            data.forEach((category) => {
                ...
                this.category_code.appendChild(option);
            });
        })
        ...
        .then((data) => {
            ...
            data.forEach((item) => {
                ...
                <tr>
                    ...
                    <td><button href="javascript:;" class='btnDel' onclick="prod.delete(${item.code})">Delete</button></td>
                </tr>
                `
            });
        })
    ...
    this.save = () => {
        ...
        form.append('category_code', this.category_code.value);
        fetch("../../controllers/prodController.php", {
            method: "POST",
            body: form,
        })
